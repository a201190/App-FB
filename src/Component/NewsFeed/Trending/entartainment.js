...
class Entertainment extends React.Component{
    constructor(){
        ...
        this.state={
            data:[
                {header:'tiger Zinda hai', link:'https://www.crickbuzz.com',paragraph:'England reached stumps on day two at 5 for 0, a lead of 65 runs, with star opener Alastair'},
                {header:'tiger Zinda hai', link:'https://www.crickbuzz.com',paragraph:'England reached stumps on day two at 5 for 0, a lead of 65 runs, with star opener Alastair'},
                {header:'tiger Zinda hai', link:'https://www.crickbuzz.com',paragraph:'England reached stumps on day two at 5 for 0, a lead of 65 runs, with star opener Alastair'}                
            ]
        }
